...
if (window.location.pathname.includes("/admin") && (!window.location.pathname.includes("/admin/new")) && (!window.location.pathname.includes("/admin/edit"))) {
    (async function() {
...
if (toggleAccess) {
    ...
    document.onclick = function() {
        signin_signup_modal.style.visibility = signin_signup_modal.style.visibility === "visible" ? "hidden" : null;
    }
}
...
next ? next.addEventListener("click", (e) => { plusSlides(1) }) : null
prev ? prev.addEventListener("click", (e) => { plusSlides(-1) }) : null
